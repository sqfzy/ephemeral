/// @file ws/bench.cpp
/// bench_ws / bench_ws_dpdk — plain WebSocket RTT bench client.
...
int main(int argc, char** argv) {
#ifdef EPH_USE_DPDK
    std::fprintf(stderr,
        "[bench_lat_ws_dpdk] WARNING: DPDK transport not yet implemented; "
        "this binary currently uses POSIX sockets identical to bench_lat_ws.\n");
    ...
    if (auto pinned = pin_thread_strict(cfg.client_cpu, "bench_ws", policy); !pinned) {
