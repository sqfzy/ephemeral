...
///
/// Pure client — connects to an external bench_mock_server.
/// Run inside a network namespace (via bench_latency.sh) to force
/// traffic through real NICs and avoid kernel loopback optimization.
///
...
int main(int argc, char** argv) {
    ...
    spdlog::info("bench_market (socket): server={}:{}, duration={}s",
                 cfg.server_ip, cfg.server_port, cfg.duration.count());
