...
/// to `benchmarks/latency/scenarios/lat_ex_md_udp_loop.hpp`'s
/// `run_lat_ex_md_udp_loop(BenchCtx&)`.
...
int main(int argc, char** argv) {
    ...
    if (port == 0) {
        std::fprintf(stderr, "lat_ex_md_udp: scenarios.lat_ex_md_udp.port required\n");
        return 1;
    }
