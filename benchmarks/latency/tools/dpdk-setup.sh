#!/usr/bin/env bash
# benchmarks/latency/tools/dpdk-setup.sh — DEPRECATED LOCATION.
#
# The canonical script lives at:
#
#     eph-net-dpdk/tools/dpdk-setup.sh
#
...
#
# Migration: invoke `eph-net-dpdk/tools/dpdk-setup.sh` directly. The
...
CANONICAL="$PROJECT_DIR/eph-net-dpdk/tools/dpdk-setup.sh"
