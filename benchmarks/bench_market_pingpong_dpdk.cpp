...
/// Combined market data + order simulation benchmark — DPDK (kernel-bypass) backend.
///
...
int main(int argc, char** argv) {
    ...
    // Unlike /stream?streams=, the /ws/ endpoint echoes client text frames,
    // enabling order RTT measurement.
    ...
    spdlog::info("Connecting via DPDK to wss://{}:{}{} ({} symbols + orders)",
    ...
    spdlog::info("Connected via DPDK ({} symbols + orders)!", cfg.symbols.size());
