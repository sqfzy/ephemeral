...
struct ParserStats {
    ...
    [[nodiscard]] friend ParserStats operator-(const ParserStats& lhs,
        ...
        // (or after a counter rollover), an unguarded subtract would
        // wrap to a huge uint64_t and silently mislead monitoring
        // dashboards. Mirror the EvictingQueueStats / BoundedQueueStats
        // pattern: clamp negatives to 0.
        return ParserStats{
