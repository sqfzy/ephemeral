...
/// Unit tests for `eph::net::dpdk::DpdkTcpStream`. Covers:
///
...
///     `TlsHandshakeFailed` (stub — real handshake requires a live TLS peer)
...
// Stub: TLS-enabled create() returns TlsHandshakeFailed without
