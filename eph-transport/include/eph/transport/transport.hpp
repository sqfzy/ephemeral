...
private:
    ...
    /// Used by send_close() and send_ping() for control frames that
    /// bypass the TX queue in certain code paths.
    ///
    ...
    // Reassembly buffer size constants (used by detail includes)
