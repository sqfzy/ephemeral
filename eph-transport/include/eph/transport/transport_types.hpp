...
// Batch frame filter (FrameView, FrameFilterFn, make_twophase_filter) —
// defined in its own header; re-exported here for backward compatibility.
#include "eph/transport/detail/frame_filter.hpp"
