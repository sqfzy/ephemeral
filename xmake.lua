...
target("simple_hft_dpdk_mp")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/simple_hft_dpdk_mp.cpp")
    add_deps("eph-net-dpdk", "eph-codec")
    apply_dpdk_pmd_linkgroups()

target("simple_hft_dpdk_rss")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/simple_hft_dpdk_rss.cpp")
    add_deps("eph-net-dpdk", "eph-codec")
    apply_dpdk_pmd_linkgroups()

target("multi_port_platform_demo")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/multi_port_platform_demo.cpp")
    add_deps("eph-net-dpdk")
    apply_dpdk_pmd_linkgroups()

target("simple_hft_dpdk_mp_dynamic")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/simple_hft_dpdk_mp_dynamic.cpp")
    add_deps("eph-net-dpdk")
    apply_dpdk_pmd_linkgroups()
