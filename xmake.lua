...
target("bench_market")
    ...
    set_group("examples")
    set_default(false)
    add_files("examples/bench_market.cpp")
    add_deps("eph-net")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")

target("bench_ws_scan")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/bench_ws_scan.cpp")
    add_deps("eph-net")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")

target("bench_single_vs_multi")
    set_kind("binary")
    set_group("examples")
    set_default(false)
    add_files("examples/bench_single_vs_multi.cpp")
    add_deps("eph-net")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")
...
target("bench_market_dpdk")
    ...
    set_group("examples")
    set_default(false)
    add_files("examples/bench_market_dpdk.cpp")
    add_deps("eph-net", "eph-dpdk")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")
...
target("bench_pingpong")
    ...
    set_group("examples")
    set_default(false)
    add_files("examples/bench_pingpong.cpp")
    add_deps("eph-net")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")
...
target("bench_pingpong_dpdk")
    ...
    set_group("examples")
    set_default(false)
    add_files("examples/bench_pingpong_dpdk.cpp")
    add_deps("eph-net", "eph-dpdk")
    add_defines("EPH_ENABLE_TIMESTAMPS=1")
    add_cxflags("-fno-omit-frame-pointer", "-march=native", { force = true })
    set_symbols("debug")
